...
export const siteContent = {
  ...
  recruiting: {
    ...
    edit: {
      add: "Add application",
      editRow: (company: string) => `Update ${company}`,
      updateHeading: "Update",
      addHeading: "Add an application",
      status: "Status",
      keepStatus: "No change, just a note",
      date: "Date",
      note: "Note",
      notePlaceholder: "What happened, in a line. Optional when you set a status.",
      company: "Company",
      role: "Role",
      lane: "Lane",
      season: "Season",
      tier: "Priority",
      tiers: { target: "Target", opportunistic: "Opportunistic" },
      submit: "Save",
      submitting: "Saving",
      cancel: "Cancel",
      pending: "Pending",
      pendingTitle: "Saved. The ledger applies it at the next hourly sync.",
      disabled: "Editing needs the vault token on this deployment.",
      failedHeading: (n: number) => `${n} ${n === 1 ? "edit" : "edits"} could not be applied in the last week`,
      failedLink: (n: number) => `See #${n}`,
